...
//        print_r($result); die();
        $res = $this->frank_api->doCurlRequest('https://p-post.herokuapp.com/api/v1/orders/rates', $result, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1ZjRjYzZhZjcwMTJiMjAwMTdjNjUzZmEiLCJlbWFpbCI6Inpha2lyQGV4YW1wbGUuY29tIiwicGFzc3dvcmQiOiJkNDFkOGNkOThmMDBiMjA0ZTk4MDA5OThlY2Y4NDI3ZSIsIm1vYmlsZSI6IjMwMDM1MDIzNDUiLCJpYXQiOjE1OTg4NjcxMTl9.-31neeE2CaCPXZYrXvvUF_vwnLvCRqIS90vp-dYQ6lE');
