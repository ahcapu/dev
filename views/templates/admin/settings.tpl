                    ...
                    <form class="add-warehouse-form" method="post">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                ...
                                <input type="text" name="warehouse_name" class="form-control add-new-warehouse-input" >
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                ...
                                <button type="submit" class="form-control btn btn-default add-new-warehouse-btn" name="add_new_warehouse_btn">Add</button>
                            </div>
                        </div>
                    </form>
