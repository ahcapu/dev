...
{*        <div class="row">*}
{*            <div class="col-sm-4 header-column">*}
{*                <a href="#">Frank</a>*}
{*            </div>*}
{*            <div class="col-sm-4 header-column">*}
{*                <a href="{$shipping}" class="shipping-link">Shipping</a>*}
...
{*    </div>*}
    ...
    <div id="main-page-id" class="container-main-page container-main-page-active">
        <div class="container-fluid mid-header">
            <div class="row">
                <div class="col-sm-8" style="display: flex; justify-content: flex-start; padding-top: 5px;">
                ...
                <div class="col-sm-2 center-block" style="display: flex; justify-content: flex-end; padding-top: 10px;">
